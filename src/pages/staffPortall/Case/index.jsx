    ...
    <Navigation/>
      ...
      <div className="grid">
        ...
        <div>
          ...
          <div className="page-description">رقم القضية : 395-63  - حالة القضية : مفتوحة </div>
          <div className="grid-2-colms">
            <div>
              <div className="case-box info">
                <div className="info-title" style={{display: 'flex', alignItems: 'center', justifyContent:'space-between'}}><img src={SandClock} alt='icon' style={{width: '16px', height: '16px'}} />زمن انجاز العمل</div>
            ...
            <div>
              <div className="case-box">
                <div className="case-title" style={{display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end'}}>معلومات عن القضية <span className="icon"><img style={{width: '16px', height: '16px', margin: '0 10px'}} src={Message} alt='icon'/></span></div>
                ...
                <p className="case-description">هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في صناعات المطابع ودور النشر. كان لوريم إيبسوم ولايزال المعيار للنص الشكلي منذ القرن الخامس عشر عندما قامت مطبعة مجهولة برص مجموعة من الأحرف بشكل عشوائي أخذتها من نص، لتكوّن كتيّب بمثابة دليل أو مرجع شكلي لهذه الأحرف</p>
              </div>
              <div className="case-box sets">
                <div className="case-title">الجلسة الثانية : <span>هو ببساطة نص شكلي</span>  </div>
                <div className="case-date">موعد الجلسة القادمة : 24 -304-32</div>
          ...
          <div className="case-box">
            <div className="case-flex">
              ...
              <div className="case-title">المهام  <span className="icon"></span></div>
            </div>
            <li className="case-description2">هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في </li>
          </div>
          <div className="case-box">
            <div className="case-flex">
              <div className="table">
              ...
              <input type="search" className="case-input" placeholder="ابحث"/>
              <div className="case-title">المراجعات  <span className="icon"></span></div>
            </div>
            <li className="case-description2">هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في </li>
          </div>
          <div className="case-box">
            <div className="case-flex">
              ...
              <input type="search" className="case-input" placeholder="ابحث"/>
              <div className="case-title">المواعيد  <span className="icon"></span></div>
            </div>
            <li className="case-description2">هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في </li>
          </div>
        </div>
